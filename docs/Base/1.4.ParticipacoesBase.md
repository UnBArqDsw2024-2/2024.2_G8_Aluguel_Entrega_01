...
| :----: | :----: | :----: | :----:|
| Arthur Gabriel  | Adição das páginas de autenticação no protótipo e criação do documento | EXCELENTE | [Protótipo](Base/prototipo.md) |
| Ester Lino | Criação e evolução do documento | EXCELENTE | [Design Sprint](Base/1.1.DesignSprint.md) |
| Lucas Macedo  | Criação do protótipo de baixa fidelidade e adição de páginas de cadastro de usuário e login | EXCELENTE | [Protótipo](Base/prototipo.md) |
...
| Nome do Membro | Contribuição | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) | Comprobatórios Claros (com link) |
| :----: | :----: | :----: | :----:|
| Ester Lino  | Ajuda na confecção do mapa mental e contribuição na correção do mapa mental | EXCELENTE | [Mapa mental](Base/mapa_mental.md) |
| Gabriel Bertolazi  | Ajuda com a confecção do mapa mental | EXCELENTE | [Mapa mental](Base/mapa_mental.md) |
| Lucas Macedo  | Criação do documento e ajuda na confecção do mapa mental | EXCELENTE | [Mapa mental](Base/mapa_mental.md) |

### Léxico

| Nome do Membro | Contribuição | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) | Comprobatórios Claros (com link) |
| :----: | :----: | :----: | :----:|
| Arthur Trindade | Elaboração do artefato Léxico | EXCELENTE | [Léxico](Base/lexicos.md) |
| Miguel Moreira  | Elaboração do artefato Léxico | EXCELENTE | [Léxico](Base/lexicos.md) |
...
| Gabriel Bertolazi  | Ajuda na confecção do bpmn do Scrum | BOA | [BPMN](Base/1.3.ModelagemBPMN.md) |
...
| Pedro Sena  | Ajuda na confecção do bpmn do mapa mental e evolução do documento | EXCELENTE | [BPMN](Base/1.3.ModelagemBPMN.md) |
